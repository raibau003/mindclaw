...
export default function Governance() {
  ...
  return (
    <div className="p-8">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-2xl font-semibold text-[#fafafa] mb-1">Governance</h1>
        <p className="text-sm text-[#666666]">AI-powered quality assurance and error recovery</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-[#111111] border border-[#1a1a1a] rounded-lg p-6">
            <h2 className="text-sm font-semibold text-[#fafafa] mb-6">Supervisor Agents</h2>
            ...
            {/* Add New Supervisor */}
            <button className="w-full mt-4 p-4 border border-dashed border-[#2a2a2a] hover:border-[#444444] rounded-md transition-colors duration-150 text-[#666666] hover:text-[#888888]">
              <PlusIcon />
          ...
          {/* Supervision Stats */}
          <div className="bg-[#111111] border border-[#1a1a1a] rounded-lg p-6">
            <h3 className="text-sm font-semibold text-[#fafafa] mb-4">Supervision Stats</h3>
            <div className="space-y-2">
              <div className="flex items-center justify-between p-3 bg-[#0a0a0a] rounded-md">
                <span className="text-xs text-[#666666]">Total Events</span>
                <span className="text-sm font-medium text-[#fafafa]">{totalSupervisions}</span>
              </div>
              <div className="flex items-center justify-between p-3 bg-[#0a0a0a] rounded-md">
                <span className="text-xs text-[#666666]">QA Reviews</span>
                <span className="text-sm font-medium text-[#888888]">{qaEvents}</span>
              </div>
              <div className="flex items-center justify-between p-3 bg-[#0a0a0a] rounded-md">
                <span className="text-xs text-[#666666]">Error Recoveries</span>
                <span className="text-sm font-medium text-[#888888]">{errorRecoveries}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-[#111111] border border-[#1a1a1a] rounded-lg p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-sm font-semibold text-[#fafafa]">Live Supervision Timeline</h2>
              <div className="flex items-center gap-2">
                <div className="w-1.5 h-1.5 bg-emerald-500 rounded-full" />
                <span className="text-xs text-[#666666]">Real-time</span>
              </div>
            </div>
            ...
            <div className="space-y-4 max-h-[600px] overflow-y-auto">
              {supervisionEvents.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-sm text-[#666666]">No supervision events yet</p>
          ...
          {/* How It Works */}
          <div className="bg-[#111111] border border-[#1a1a1a] rounded-lg p-6">
            <h3 className="text-sm font-semibold text-[#fafafa] mb-4">How Supervision Works</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 bg-[#0a0a0a] border border-[#1a1a1a] rounded-md">
                <div className="w-9 h-9 rounded-md bg-[#1a1a1a] flex items-center justify-center mb-3">
                  <QAIcon />
                </div>
                <h4 className="text-sm font-medium text-[#fafafa] mb-1">QA Supervisor</h4>
              ...
              <div className="p-4 bg-[#0a0a0a] border border-[#1a1a1a] rounded-md">
                ...
                <h4 className="text-sm font-medium text-[#fafafa] mb-1">Error Recovery</h4>
                <p className="text-xs text-[#666666]">
...
function QAIcon() {
  return (
    <svg className="w-4 h-4 text-[#888888]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
